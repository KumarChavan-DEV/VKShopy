package com.vkdream.vkshopy.ui.custom
...
class VKDotProgressBar : FrameLayout {
    ...
    class Builder {
        ...
        private var primaryAnimator: ValueAnimator? = null
        private var dotBackground = R.drawable.ic_dot
        fun build(context: Context): VKDotProgressBar {
            val dotProgressBar = VKDotProgressBar(context)
